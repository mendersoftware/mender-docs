...
user@local$ git diff HEAD..1.2.0 -- template
```
...
> ...  
> Pulling mender-device-auth (mendersoftware/deviceauth:1.2.0)...  
...
> Status: Image is up to date for mendersoftware/deviceauth:1.2.0  
> Pulling mender-gui (mendersoftware/gui:1.2.0)...  
> 1.0.x: Pulling from mendersoftware/gui  
> Digest: sha256:af2d2349f27dd96ca21940672aa3a91335b17153f8c7ef2ca865a9a7fdf2fd22  
> Status: Image is up to date for mendersoftware/gui:1.2.0  
> Pulling mender-api-gateway (mendersoftware/api-gateway:1.2.0)...  
...
> Status: Image is up to date for mendersoftware/api-gateway:1.2.0````  
