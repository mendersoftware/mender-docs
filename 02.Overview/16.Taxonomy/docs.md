...
* _Identity (Component)_ - In the context of orchestrating updates, an attribute provided by the _Component’s Interface_ that uniquely identifies it. This attribute may change (for example, when a _Component_ is physically replaced), making the change visible.
...
* _Interface_ - Used in the context of orchestrating updates. An Interface used for updating _Components_. See the
