...
* The `mender-cli` tool. You can find information about how to download it and the installation steps in the [Downloads section](../../11.Downloads/01.Workstation-tools/docs.md#mender-cli) from this documentation.
