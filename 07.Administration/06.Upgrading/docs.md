...
>    02cd118..75b7831  2.2.0      -> origin/2.2.0
>    06f3212..e9e5df4  2.2.0     -> origin/2.2.0  
> ```
...
user@local$ git diff HEAD..2.2.0 -- template
```
...
> ...  
> Pulling mender-device-auth (mendersoftware/deviceauth:2.1.0)...  
...
> Pulling mender-gui (mendersoftware/gui:2.2.0)...  
> 2.2.0: Pulling from mendersoftware/gui  
> Digest: sha256:af2d2349f27dd96ca21940672aa3a91335b17153f8c7ef2ca865a9a7fdf2fd22  
> Status: Image is up to date for mendersoftware/gui:2.2.0  
