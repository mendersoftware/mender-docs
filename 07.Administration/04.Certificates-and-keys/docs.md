...
| Mender Artifact | Signs and verifies [Mender Artifacts](../../02.Overview/05.Artifact/docs.md). | The **Signing system** stores the private key used for signing Mender artifacts. After an artifact is signed using the private key it is verified by the **Mender Clients**. |
