...
The Mender backend consits of a number microservices, each implementing a
...
the official [Mender Docker repository](https://hub.docker.com/r/mendersoftware/?target=_blank).
