...
sudo DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_2.2.1-1_armhf.deb
sudo mender setup \
...
As an alternative to using a Debian package, it is possible to install the Mender client from source by following the guidelines outlined in the [README.md](https://github.com/mendersoftware/mender/tree/2.2.1#installing-from-source) of the Mender client source repository.
