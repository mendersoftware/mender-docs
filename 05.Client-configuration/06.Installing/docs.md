...
It is possible to install the Mender client from source by following the guidelines outlined in the [README.md](https://github.com/mendersoftware/mender/tree/2.0.1#installing-from-source) of the Mender client source repository.
