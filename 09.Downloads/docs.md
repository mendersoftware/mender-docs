...
|----------|--------------------------------------------------------------|
| Linux    | [mender-artifact 3.6.1-build7][x.x.x_mender-artifact-linux]     |
| Mac OS X | [mender-artifact 3.6.1-build7][x.x.x_mender-artifact-darwin] |
...
<!--AUTOVERSION: "mender-artifact/%/"/mender-artifact -->
[x.x.x_mender-artifact-linux]: https://downloads.mender.io/mender-artifact/3.6.1-build7/linux/mender-artifact
<!--AUTOVERSION: "mender-artifact/%/"/mender-artifact -->
[x.x.x_mender-artifact-darwin]: https://downloads.mender.io/mender-artifact/3.6.1-build7/darwin/mender-artifact
...
|----------------|-------------------------------------------|---------------------------------------------------------------------|
| armhf (ARM-v6) | ARM 32bit distributions, for example Raspberry Pi OS for Raspberry Pi or Debian for BeagleBone | [mender-client_3.1.0-build7-1_armhf.deb][mender-client_x.x.x-1_armhf.deb] |
| arm64 | ARM 64bit processors, for example Debian for Asus Tinker Board | [mender-client_3.1.0-build7-1_arm64.deb][mender-client_x.x.x-1_arm64.deb] |
| amd64 | Generic 64-bit x86 processors, the most popular among workstations | [mender-client_3.1.0-build7-1_amd64.deb][mender-client_x.x.x-1_amd64.deb] |

<!--AUTOVERSION: "downloads.mender.io/%/"/mender "mender-client_%-1_armhf.deb"/mender -->
[mender-client_x.x.x-1_armhf.deb]: https://downloads.mender.io/3.1.0-build7/dist-packages/debian/armhf/mender-client_3.1.0-build7-1_armhf.deb
<!--AUTOVERSION: "downloads.mender.io/%/"/mender "mender-client_%-1_arm64.deb"/mender -->
[mender-client_x.x.x-1_arm64.deb]: https://downloads.mender.io/3.1.0-build7/dist-packages/debian/arm64/mender-client_3.1.0-build7-1_arm64.deb
<!--AUTOVERSION: "downloads.mender.io/%/"/mender "mender-client_%-1_amd64.deb"/mender -->
[mender-client_x.x.x-1_amd64.deb]: https://downloads.mender.io/3.1.0-build7/dist-packages/debian/amd64/mender-client_3.1.0-build7-1_amd64.deb
...
curl --fail -u "$HOSTED_MENDER_EMAIL" -O https://downloads.customer.mender.io/content/hosted/mender-monitor/debian/1.0.0-build7/mender-monitor_1.0.0-build7-1_all.deb
```
[/ui-tab]
...
curl --fail -u $MENDER_ENTERPRISE_EMAIL -O https://downloads.customer.mender.io/content/on-prem/mender-monitor/debian/1.0.0-build7/mender-monitor_1.0.0-build7-1_all.deb
```
[/ui-tab]
[/ui-tabs]
...
```bash
dpkg -i mender-monitor_1.0.0-build7-1_all.deb
