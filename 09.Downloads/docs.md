...
|----------|--------------------------------------------------------|-----------------------------------------------------------------------|
| Linux    | [mender-artifact 3.7.0-build2][x.x.x_mender-artifact-linux]  | [mender-artifact master][master_mender-artifact-linux] (Pre-release)  |
| Mac OS X | [mender-artifact 3.7.0-build2][x.x.x_mender-artifact-darwin] | [mender-artifact master][master_mender-artifact-darwin] (Pre-release) |
...
[x.x.x_mender-artifact-linux]: https://downloads.mender.io/mender-artifact/3.7.0-build2/linux/mender-artifact
[x.x.x_mender-artifact-darwin]: https://downloads.mender.io/mender-artifact/3.7.0-build2/darwin/mender-artifact
...
|----------------|------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|------------------------------------------------------------------------------------|
| armhf (ARM-v6) | ARM 32bit distributions, for example Raspberry Pi OS for Raspberry Pi or Debian for BeagleBone | [mender-client_3.2.0-build2-1_armhf.deb][mender-client_x.x.x-1_armhf.deb] | [mender-client_3.2.0-build2-1_armhf.deb][mender-client_3.2.0-build2-1_armhf.deb] (Pre-release) |
| arm64          | ARM 64bit processors, for example Debian for Asus Tinker Board                                 | [mender-client_3.2.0-build2-1_arm64.deb][mender-client_x.x.x-1_arm64.deb] | [mender-client_3.2.0-build2-1_arm64.deb][mender-client_3.2.0-build2-1_arm64.deb] (Pre-release) |
| amd64          | Generic 64-bit x86 processors, the most popular among workstations                             | [mender-client_3.2.0-build2-1_amd64.deb][mender-client_x.x.x-1_amd64.deb] | [mender-client_3.2.0-build2-1_amd64.deb][mender-client_3.2.0-build2-1_amd64.deb] (Pre-release) |

<!--AUTOVERSION: "downloads.mender.io/%/"/mender "mender-client_%-1_"/mender -->
[mender-client_x.x.x-1_armhf.deb]: https://downloads.mender.io/3.2.0-build2/dist-packages/debian/armhf/mender-client_3.2.0-build2-1_armhf.deb
[mender-client_x.x.x-1_arm64.deb]: https://downloads.mender.io/3.2.0-build2/dist-packages/debian/arm64/mender-client_3.2.0-build2-1_arm64.deb
[mender-client_x.x.x-1_amd64.deb]: https://downloads.mender.io/3.2.0-build2/dist-packages/debian/amd64/mender-client_3.2.0-build2-1_amd64.deb
...
| Platform | Download link                                |                                                             |
|----------|----------------------------------------------|-------------------------------------------------------------|
| Linux    | [mender-cli 1.7.1-build2][x.x.x_mender-cli-linux]  | [mender-cli master][master_mender-cli-linux] (Pre-release)  |
| Mac OS X | [mender-cli 1.7.1-build2][x.x.x_mender-cli-darwin] | [mender-cli master][master_mender-cli-darwin] (Pre-release) |
...
[x.x.x_mender-cli-linux]: https://downloads.mender.io/mender-cli/1.7.1-build2/linux/mender-cli
[x.x.x_mender-cli-darwin]: https://downloads.mender.io/mender-cli/1.7.1-build2/darwin/mender-cli
...
curl --fail -u "$HOSTED_MENDER_EMAIL" -O https://downloads.customer.mender.io/content/hosted/mender-monitor/debian/1.1.0-build2/mender-monitor_1.1.0-build2-1_all.deb
```
[/ui-tab]
...
curl --fail -u $MENDER_ENTERPRISE_EMAIL -O https://downloads.customer.mender.io/content/on-prem/mender-monitor/debian/1.1.0-build2/mender-monitor_1.1.0-build2-1_all.deb
```
[/ui-tab]
[/ui-tabs]
...
```bash
dpkg -i mender-monitor_1.1.0-build2-1_all.deb
...
```bash
HOSTED_MENDER_EMAIL=<your.email@example.com>
curl --fail -u "$HOSTED_MENDER_EMAIL" -O https://downloads.customer.mender.io/content/hosted/mender-monitor/debian/1.1.0-build2/mender-monitor_demo_1.1.0-build2-1_all.deb
```
[/ui-tab]
[ui-tab title="enterprise"]
<!--AUTOVERSION: "/mender-monitor_demo_%-1_all.deb"/monitor-client "/mender-monitor/debian/%/"/monitor-client -->
```bash
MENDER_ENTERPRISE_EMAIL=<your.email@example.com>
curl --fail -u $MENDER_ENTERPRISE_EMAIL -O https://downloads.customer.mender.io/content/on-prem/mender-monitor/debian/1.1.0-build2/mender-monitor_demo_1.1.0-build2-1_all.deb
```
[/ui-tab]
[/ui-tabs]
...
```bash
dpkg -i mender-monitor_demo_1.1.0-build2-1_all.deb
```
