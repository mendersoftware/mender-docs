...
|----------------|------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|------------------------------------------------------------------------------------|
| armhf (ARM-v6) | ARM 32bit distributions, for example Raspberry Pi OS for Raspberry Pi or Debian for BeagleBone | [mender-client_3.2.0-build3-1_armhf.deb][mender-client_x.x.x-1_armhf.deb] | [mender-client_3.2.0-build3-1_armhf.deb][mender-client_3.2.0-build3-1_armhf.deb] (Pre-release) |
| arm64          | ARM 64bit processors, for example Debian for Asus Tinker Board                                 | [mender-client_3.2.0-build3-1_arm64.deb][mender-client_x.x.x-1_arm64.deb] | [mender-client_3.2.0-build3-1_arm64.deb][mender-client_3.2.0-build3-1_arm64.deb] (Pre-release) |
| amd64          | Generic 64-bit x86 processors, the most popular among workstations                             | [mender-client_3.2.0-build3-1_amd64.deb][mender-client_x.x.x-1_amd64.deb] | [mender-client_3.2.0-build3-1_amd64.deb][mender-client_3.2.0-build3-1_amd64.deb] (Pre-release) |

<!--AUTOVERSION: "downloads.mender.io/%/"/mender "mender-client_%-1_"/mender -->
[mender-client_x.x.x-1_armhf.deb]: https://downloads.mender.io/3.2.0-build3/dist-packages/debian/armhf/mender-client_3.2.0-build3-1_armhf.deb
[mender-client_x.x.x-1_arm64.deb]: https://downloads.mender.io/3.2.0-build3/dist-packages/debian/arm64/mender-client_3.2.0-build3-1_arm64.deb
[mender-client_x.x.x-1_amd64.deb]: https://downloads.mender.io/3.2.0-build3/dist-packages/debian/amd64/mender-client_3.2.0-build3-1_amd64.deb
...
curl --fail -u "$HOSTED_MENDER_EMAIL" -O https://downloads.customer.mender.io/content/hosted/mender-monitor/debian/1.1.0-build3/mender-monitor_1.1.0-build3-1_all.deb
```
[/ui-tab]
...
curl --fail -u $MENDER_ENTERPRISE_EMAIL -O https://downloads.customer.mender.io/content/on-prem/mender-monitor/debian/1.1.0-build3/mender-monitor_1.1.0-build3-1_all.deb
```
[/ui-tab]
[/ui-tabs]
...
```bash
dpkg -i mender-monitor_1.1.0-build3-1_all.deb
...
```bash
HOSTED_MENDER_EMAIL=<your.email@example.com>
curl --fail -u "$HOSTED_MENDER_EMAIL" -O https://downloads.customer.mender.io/content/hosted/mender-monitor/debian/1.1.0-build3/mender-monitor_demo_1.1.0-build3-1_all.deb
```
[/ui-tab]
[ui-tab title="enterprise"]
<!--AUTOVERSION: "/mender-monitor_demo_%-1_all.deb"/monitor-client "/mender-monitor/debian/%/"/monitor-client -->
```bash
MENDER_ENTERPRISE_EMAIL=<your.email@example.com>
curl --fail -u $MENDER_ENTERPRISE_EMAIL -O https://downloads.customer.mender.io/content/on-prem/mender-monitor/debian/1.1.0-build3/mender-monitor_demo_1.1.0-build3-1_all.deb
```
[/ui-tab]
[/ui-tabs]
...
```bash
dpkg -i mender-monitor_demo_1.1.0-build3-1_all.deb
```
