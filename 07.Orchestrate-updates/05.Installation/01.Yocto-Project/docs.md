...
```bash
curl --fail -u $HOSTED_MENDER_EMAIL -o ${HOME}/mender-orchestrator-0.7.0.tar.xz https://downloads.customer.mender.io/content/hosted/mender-orchestrator/yocto/0.7.0/mender-orchestrator-0.7.0.tar.xz
```
[/ui-tab]
...
<!--AUTOVERSION: "/mender-orchestrator/yocto/%/"/mender-orchestrator "/mender-orchestrator-%.tar.xz"/mender-orchestrator -->
```bash
curl --fail -u $MENDER_ENTERPRISE_USER -o ${HOME}/mender-orchestrator-0.7.0.tar.xz https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/yocto/0.7.0/mender-orchestrator-0.7.0.tar.xz
```
[/ui-tab]
[/ui-tabs]
...
```bash
SRC_URI:pn-mender-orchestrator = "file://${HOME}/mender-orchestrator-0.7.0.tar.xz"
```
