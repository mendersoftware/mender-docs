...
This section walks you through updating a **second Raspberry Pi** from a first one
...
Now restart the broker, so it picks up the listener config the demo package
just installed:
