...
| Client vs meta-mender version   | Older              | pyro (2.3) | rocko (2.4)           | sumo (2.5)            | thud (2.6)            | warrior (2.7)<sup>4</sup> | zeus (3.0) | dunfell (3.1) |
|---------------------------------|--------------------|------------|-----------------------|-----------------------|-----------------------|---------------------------|------------|---------------|
| Mender client 1.0.x             | Varies<sup>1</sup> | no         | no                    | no                    | no                    | no                        | no         | no            |
| Mender client 1.1.x             | Varies<sup>1</sup> | community  | no                    | no                    | no                    | no                        | no         | no            |
| Mender client 1.2.x             | Varies<sup>1</sup> | community  | community             | no                    | no                    | no                        | no         | no            |
| Mender client 1.3.x             | Varies<sup>1</sup> | community  | community             | community             | no                    | no                        | no         | no            |
| Mender client 1.4.x             | Varies<sup>1</sup> | community  | community             | community             | no                    | no                        | no         | no            |
| Mender client 1.5.x             | Varies<sup>1</sup> | community  | community             | community             | community             | no                        | no         | no            |
| Mender client 1.6.x             | Varies<sup>1</sup> | community  | community             | community             | community             | no                        | no         | no            |
| Mender client 1.7.x<sup>2</sup> | Varies<sup>1</sup> | community  | community<sup>3</sup> | community<sup>3</sup> | community<sup>3</sup> | community                 | no         | no            |
| Mender client 2.0.x             | no                 | no         | community             | community             | community             | community                 | no         | no            |
| Mender client 2.1.x             | no                 | no         | community             | community             | community             | community                 | no         | no            |
| Mender client 2.2.x             | no                 | no         | no                    | community             | community             | community                 | community  | stable        |
