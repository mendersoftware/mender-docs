...
executable from the [downloads section](../../11.Downloads)
...
We will use the [single file](https://hub.mender.io/t/single-file/486/26?target=_blank) [Update Module](../../07.Artifact-creation/08.Create-a-custom-Update-Module/docs.md) to create a *module-image*.
...
Module](../../07.Artifact-creation/08.Create-a-custom-Update-Module/docs.md). The Artifact created
