...
[mender-artifact](../../../11.Downloads/01.Workstation-tools/docs.md#mender-artifact) (version >= 3.0) installed
...
[mender-artifact](../../../11.Downloads/01.Workstation-tools/docs.md#mender-artifact) tool to create
...
session using the [mender-cli](../../../11.Downloads/01.Workstation-tools/docs.md#mender-cli).
```bash
