...
!!!!! The templates use the [Personal Access Tokens](../../../09.Server-integration/01.Using-the-apis/docs.md#personal-access-tokens) feature which is only available in Mender Server version 3.4 or newer.
