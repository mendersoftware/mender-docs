...
This section describes the steps that are specific to production builds for Yocto project. If you are using Debian converted images please refer to [setting parameters for image conversion tool](../image-configuration/debian-family-converted-image-configuration)
