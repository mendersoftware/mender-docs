...
[x.x.x_mender-artifact]: https://d1b0l86ne08fsf.cloudfront.net/mender-artifact/2.3.1/mender-artifact
...
```bash
mender-artifact write rootfs-image -t beaglebone -n mender-1.6.1 -u core-image-base-beaglebone.ext4 -k private.key -o artifact-signed.mender
```
