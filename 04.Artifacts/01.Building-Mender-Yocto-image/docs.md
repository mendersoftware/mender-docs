...
# We recommend Mender 1.4.0b1 and Yocto Project's rocko or later for Hosted Mender.
#
...
## Configuring the image with read-only rootfs
...
can be followed up here: http://lists.openembedded.org/pipermail/openembedded-core/2018-January/146834.html
