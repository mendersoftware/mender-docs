...
Take a look at the [example-state-scripts](https://github.com/mendersoftware/meta-mender/tree/rocko/meta-mender-demo/recipes-mender/example-state-scripts) recipe to get started.
