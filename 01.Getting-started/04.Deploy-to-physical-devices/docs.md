...
```bash
cp beagleboneblack_release_1_2.0.1.mender beagleboneblack_release_2_2.0.1.mender
mender-artifact modify beagleboneblack_release_2_2.0.1.mender -n release-2_2.0.1
```
