...
```
PREFERRED_VERSION_mender-client = "3.1.0-build7"
```
...
Error:
 Problem: package grub-efi-mender-precompiled-2.04-r0.cortexa8hf_neon requires u-boot, but none of the providers can be installed
  ...
  - package mender-3.1.0-build7-r0.cortexa8hf_neon requires grub-editenv, but none of the providers can be installed
