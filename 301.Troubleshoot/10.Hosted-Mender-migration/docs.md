...
Using the script [single-file-artifact-gen](https://github.com/mendersoftware/mender/blob/3.4.0/support/modules-artifact-gen/single-file-artifact-gen) makes this process easier.
