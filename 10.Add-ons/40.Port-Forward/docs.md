...
* Install [mender-connect](../../11.Downloads/02.Device-components/docs.md#mender-connect) on the
  device.
...
* Install [mender-cli](../../11.Downloads/01.Workstation-tools/docs.md#mender-cli) on your workstation.
