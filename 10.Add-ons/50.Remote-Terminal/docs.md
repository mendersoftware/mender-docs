...
All you need is 
[mender-connect](../../11.Downloads/02.Device-components/docs.md#remote-terminal-add-on)
...
To achieve this please download the [mender-cli](../../11.Downloads/01.Workstation-tools/docs.md#mender-cli) tool.
...
For the access token you can use whatever way works best for you, a [PAT](../../09.Server-integration/01.Using-the-apis/docs.md#personal-access-tokens) or a session token (`Settings -> My profile -> Session token`) are the quickest.
