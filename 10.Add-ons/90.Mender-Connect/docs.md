...
* [installation with a deb](../../11.Downloads/02.Device-components/docs.md#remote-terminal-add-on) for the installation from the Debian package

After installation, please refer to the [add-ons subsections](../../10.Add-ons/chapter.md) for the configuration options,
