...
Once your devices support installing delta updates, see [Create a Delta update Artifact](../../../07.Artifact-creation/05.Create-a-Delta-update-Artifact/docs.md) for a tutorial on how to create a delta update from two Operating System updates.
...
Download the `mender-binary-delta` binaries following the [instructions](../../../11.Downloads/02.Device-components/docs.md#mender-binary-delta).
...
For information on how to create delta update Artifacts, see [Create a Delta update Artifact](../../../07.Artifact-creation/05.Create-a-Delta-update-Artifact/docs.md).
