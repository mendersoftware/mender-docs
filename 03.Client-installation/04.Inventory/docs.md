...
We recommend that you first read the [overview on Inventory](../../02.Overview/08.Inventory) in order to familiarize yourself with the concept and how it is used in Mender. This tutorial is about how to change the Inventory attributes reported by the Mender-update client.


## Basic rules for inventory attributes

Periodically, the Mender-update client runs every executable file with
...
By default, and without any inventory scripts added, the Mender-update client sends the following attributes:
