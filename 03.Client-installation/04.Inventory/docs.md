...
You can find some more useful scripts in [https://github.com/mendersoftware/mender/support](https://github.com/mendersoftware/mender/tree/2.5.0-build2/support) directory.
...
| `mender_client_version` | client version | "2.5.0-build2" |
