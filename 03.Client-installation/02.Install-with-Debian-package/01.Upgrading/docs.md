...
In the [Mender APT repositories](../../../11.Downloads/02.Device-components/docs.md#set-up-the-apt-repository) `mender-client`
package corresponds to the Mender Client written in Go (version 3.x.y). This package is installed by default
from our [Express installation script](../../../11.Downloads/02.Device-components/docs.md#express-installation). To upgrade from the
