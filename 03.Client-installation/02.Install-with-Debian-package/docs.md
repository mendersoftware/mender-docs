...
```bash
wget https://downloads.mender.io/2.5.3/dist-packages/debian/armhf/mender-client_2.5.3-1_armhf.deb
```
...
```bash
sudo dpkg -i mender-client_2.5.3-1_armhf.deb
```
...
sudo DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_2.5.3-1_armhf.deb
sudo mender setup \
...
[README.md](https://github.com/mendersoftware/mender/tree/2.5.3#installing-from-source?target=_blank)
