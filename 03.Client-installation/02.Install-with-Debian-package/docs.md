...
```bash
wget https://downloads.mender.io/3.0.1/dist-packages/debian/armhf/mender-client_3.0.1-1_armhf.deb
```
...
```bash
sudo dpkg -i mender-client_3.0.1-1_armhf.deb
```
...
sudo DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_3.0.1-1_armhf.deb
sudo mender setup \
...
[README.md](https://github.com/mendersoftware/mender/tree/3.0.1#installing-from-source?target=_blank)
