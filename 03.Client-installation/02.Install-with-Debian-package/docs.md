...
```bash
wget https://downloads.mender.io/2.6.0/dist-packages/debian/armhf/mender-client_2.6.0-1_armhf.deb
```
...
```bash
sudo dpkg -i mender-client_2.6.0-1_armhf.deb
```
...
[README.md](https://github.com/mendersoftware/mender/tree/2.6.0#installing-from-source?target=_blank)
