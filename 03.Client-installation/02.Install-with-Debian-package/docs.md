...
```bash
sudo dpkg -i mender-client_3.2.1-1%2Bdebian%2Bbuster_armhf.deb
```
...
sudo DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_3.2.1-1%2Bdebian%2Bbuster_armhf.deb
sudo mender setup \
...
[README.md](https://github.com/mendersoftware/mender/tree/3.2.1#installing-from-source?target=_blank)
