...
```bash
wget https://downloads.mender.io/2.6.0-build1/dist-packages/debian/armhf/mender-client_2.6.0-build1-1_armhf.deb
```
...
```bash
sudo dpkg -i mender-client_2.6.0-build1-1_armhf.deb
```
...
sudo DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_2.6.0-build1-1_armhf.deb
sudo mender setup \
...
[README.md](https://github.com/mendersoftware/mender/tree/2.6.0-build1#installing-from-source?target=_blank)
