...
```bash
wget https://downloads.mender.io/mender-3.2.0-build3/dist-packages/debian/armhf/mender-client_mender-3.2.0-build3-1_armhf.deb
```
...
```bash
sudo dpkg -i mender-client_mender-3.2.0-build3-1_armhf.deb
```
...
sudo DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_mender-3.2.0-build3-1_armhf.deb
sudo mender setup \
...
[README.md](https://github.com/mendersoftware/mender/tree/mender-3.2.0-build3#installing-from-source?target=_blank)
