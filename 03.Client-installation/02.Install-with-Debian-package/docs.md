...
```bash
sudo dpkg -i mender-client_3.0.2-1%2Bdebian%2Bbuster_armhf.deb
```
...
sudo DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_3.0.2-1%2Bdebian%2Bbuster_armhf.deb
sudo mender setup \
