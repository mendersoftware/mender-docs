...
```bash
wget https://downloads.mender.io/3.2.0-build5/dist-packages/debian/armhf/mender-client_3.2.0-build5-1_armhf.deb
```
...
```bash
sudo dpkg -i mender-client_3.2.0-build5-1_armhf.deb
```
...
sudo DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_3.2.0-build5-1_armhf.deb
sudo mender setup \
...
[README.md](https://github.com/mendersoftware/mender/tree/3.2.0-build5#installing-from-source?target=_blank)
