...
<!--AUTOMATION: execute=wget https://downloads.mender.io/repos/debian/pool/main/m/mender-client/mender-client_3.3.2-1%2Bdebian%2Bbullseye_$(dpkg --print-architecture).deb -->

<!--AUTOVERSION: "mender-client_%-1"/mender -->
<!--AUTOMATION: execute=DEBIAN_FRONTEND=noninteractive dpkg -i mender-client_3.3.2-1+debian+bullseye_$(dpkg --print-architecture).deb -->
...
[README.md](https://github.com/mendersoftware/mender/tree/3.3.2#installing-from-source?target=_blank)
