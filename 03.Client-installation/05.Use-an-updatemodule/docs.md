...
Client executes these files with a defined set of parameters to [perform the update](../../08.Artifact-creation/10.Create-a-custom-Update-Module/docs.md#The-state-machine-workflow).
All Update Modules originate from the artifacts of [a special payload and type](../../08.Artifact-creation/10.Create-a-custom-Update-Module/docs.md#Create-an-Artifact-with-a-payload-for-the-new-Update-Module).
