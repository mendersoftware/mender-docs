...
Example scripts are provided in the [support directory in the Mender Client source code repository](https://github.com/mendersoftware/mender/tree/5.1.0/support?target=_blank).
