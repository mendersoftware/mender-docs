...
patch for
BeagleBone](https://github.com/mendersoftware/meta-mender/blob/master/recipes-bsp/u-boot/files/0001-BBB-Use-Mender-boot-code-for-selecting-boot-device-a.patch?target=_blank)
