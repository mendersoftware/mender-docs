...
```
curl -O https://raw.githubusercontent.com/mendersoftware/mender/5.0.0/support/modules-artifact-gen/single-file-artifact-gen
...
[single file Update Module](https://github.com/mendersoftware/mender/blob/5.0.0/support/modules/single-file?target=_blank)
...
For more details on how to write Update Modules, visit the [Create a custom Update Module](../08.Create-a-custom-Update-Module/docs.md) section and the [Update Module API specification](https://github.com/mendersoftware/mender/blob/5.0.0/Documentation/update-modules-v3-file-api.md?target=_blank).
