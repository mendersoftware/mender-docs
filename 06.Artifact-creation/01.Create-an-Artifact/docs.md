...
[single file Update Module](https://github.com/mendersoftware/mender/blob/4.0.5/support/modules/single-file?target=_blank)
...
For more details on how to write Update Modules, visit the [Create a custom Update Module](../08.Create-a-custom-Update-Module/docs.md) section and the [Update Module API specification](https://github.com/mendersoftware/mender/blob/4.0.5/Documentation/update-modules-v3-file-api.md?target=_blank).
