...
Update Modules follow the same execution flow as [state scripts](../../08.Artifact-creation/04.State-scripts/docs.md). For the development of Update Modules it is important to have a basic understanding of it.
...
The best and recommended way of running Mender is the [managed mode](../../02.Overview/01.Introduction/docs.md#client-modes-of-operation) with [hosted Mender](https://hosted.mender.io?target=_blank). You can also try the [on-premise demo server](../../09.Server-installation/02.Evaluation-with-docker-compose/docs.md) for quick testing.
...
* [Update Modules v3 protocol](https://github.com/mendersoftware/mender/blob/5.1.0/Documentation/update-modules-v3-file-api.md?target=_blank)
