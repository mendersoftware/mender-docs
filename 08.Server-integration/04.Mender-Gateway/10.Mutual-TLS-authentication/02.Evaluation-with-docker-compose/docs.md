...
If you have a security practice to exchange keys on the device as long as the new key is signed by the CA the gateway trusts, the device will reaccepted with the new key. It will have two pairs of accepted [auth sets](../../../../02.Overview/14.Device-authentication/docs.md#identification-and-authentication).
