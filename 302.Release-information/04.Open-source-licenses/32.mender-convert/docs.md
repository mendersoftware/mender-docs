...
All open source licenses used in mender-convert with the default build are shown below.
...
* Name: mender-convert
* License: [Apache-2.0](https://github.com/mendersoftware/mender-convert/blob/HEAD/LICENSE)
