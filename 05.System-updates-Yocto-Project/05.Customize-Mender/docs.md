...
https://downloads.customer.mender.io/content/hosted/mender-monitor/yocto/1.1.0-build2/mender-monitor-1.1.0-build2.tar.gz
...
curl --fail -u $HOSTED_MENDER_EMAIL -o ${HOME}/mender-monitor-1.1.0-build2.tar.gz https://downloads.customer.mender.io/content/hosted/mender-monitor/yocto/1.1.0-build2/mender-monitor-1.1.0-build2.tar.gz
```
[/ui-tab]
...
curl --fail -u $MENDER_ENTERPRISE_EMAIL -o ${HOME}/mender-monitor-1.1.0-build2.tar.gz https://downloads.customer.mender.io/content/on-prem/mender-monitor/yocto/1.1.0-build2/mender-monitor-1.1.0-build2.tar.gz
```
[/ui-tab]
[/ui-tabs]
...
```bash
SRC_URI_pn-mender-monitor = "file://${HOME}/mender-monitor-1.1.0-build2.tar.gz"
```
