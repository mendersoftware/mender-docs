...
https://downloads.customer.mender.io/content/hosted/mender-monitor/yocto/1.2.1-build5/mender-monitor-1.2.1-build5.tar.gz
...
curl --fail -u $HOSTED_MENDER_EMAIL -o ${HOME}/mender-monitor-1.2.1-build5.tar.gz https://downloads.customer.mender.io/content/hosted/mender-monitor/yocto/1.2.1-build5/mender-monitor-1.2.1-build5.tar.gz
```
[/ui-tab]
...
curl --fail -u $MENDER_ENTERPRISE_EMAIL -o ${HOME}/mender-monitor-1.2.1-build5.tar.gz https://downloads.customer.mender.io/content/on-prem/mender-monitor/yocto/1.2.1-build5/mender-monitor-1.2.1-build5.tar.gz
```
[/ui-tab]
[/ui-tabs]
...
```bash
SRC_URI:pn-mender-monitor = "file://${HOME}/mender-monitor-1.2.1-build5.tar.gz"
```
...
https://downloads.customer.mender.io/content/hosted/mender-gateway/yocto/1.0.1-build5/mender-gateway-1.0.1-build5.tar.xz
and download the tarball to a known location on your local system using your hosted
Mender username and password:
...
```bash
HOSTED_MENDER_EMAIL=<your.email@example.com>
curl --fail -u $HOSTED_MENDER_EMAIL -o ${HOME}/mender-gateway-1.0.1-build5.tar.xz https://downloads.customer.mender.io/content/hosted/mender-gateway/yocto/1.0.1-build5/mender-gateway-1.0.1-build5.tar.xz
```
[/ui-tab]
[ui-tab title="enterprise"]
<!--AUTOVERSION: "/mender-gateway/yocto/%/"/mender-gateway "/mender-gateway-%.tar.xz"/mender-gateway -->
```bash
MENDER_ENTERPRISE_EMAIL=<your.email@example.com>
curl --fail -u $MENDER_ENTERPRISE_EMAIL -o ${HOME}/mender-gateway-1.0.1-build5.tar.xz https://downloads.customer.mender.io/content/on-prem/mender-gateway/yocto/1.0.1-build5/mender-gateway-1.0.1-build5.tar.xz
```
[/ui-tab]
[/ui-tabs]
...
```bash
SRC_URI:pn-mender-gateway = "file://${HOME}/mender-gateway-1.0.1-build5.tar.xz"
```
...
```bash
SRC_URI:pn-mender-gateway:append = " file:///${HOME}/mender-gateway-examples-1.0.1-build5.tar"
```
