...
```bash
SRC_URI:pn-mender-monitor = "file://${HOME}/mender-monitor-1.2.0.tar.gz"
```
...
```bash
SRC_URI:pn-mender-gateway = "file://${HOME}/mender-gateway-1.0.0.tar.xz"
```
...
```bash
SRC_URI:pn-mender-gateway:append = " file:///${HOME}/mender-gateway-examples-1.0.0.tar"
```
