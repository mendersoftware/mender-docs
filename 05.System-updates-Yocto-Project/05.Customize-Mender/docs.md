...
```bash
SRC_URI_pn-mender-monitor = "file://${HOME}/mender-monitor-1.2.1.tar.gz"
```
...
```bash
SRC_URI_pn-mender-gateway = "file://${HOME}/mender-gateway-1.0.1.tar.xz"
```
...
```bash
SRC_URI_pn-mender-gateway_append = " file:///${HOME}/mender-gateway-examples-1.0.1.tar"
```
