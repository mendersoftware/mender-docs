...
curl -u $HOSTED_MENDER_EMAIL -O https://downloads.customer.mender.io/hosted/content/mender-binary-delta/1.2.1/mender-binary-delta-1.2.1.tar.xz
```
...
curl -u $MENDER_ENTERPRISE_EMAIL -O https://downloads.customer.mender.io/content/mender-binary-delta/1.2.1/mender-binary-delta-1.2.1.tar.xz
```
