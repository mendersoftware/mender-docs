...
<!--AUTOVERSION: "Google Authenticator v%"/ignore-->
## Two factor authentication: known problems with Google Authenticator v3.0.1 on iOS

<!--AUTOVERSION: "Google Authenticator v%"/ignore "generated by Mender %"/mender-->
Google Authenticator v3.0.1 does not properly interpret otp URIs generated by Mender 2.2. It will respond with "Invalid barcode" upon scanning of the QR.

<!--AUTOVERSION: "Google Authenticator v%"/ignore "part of the Mender %"/mender-->
The fix is already prepared and will be part of the Mender 2.2.1 release. The workaround is to use a different authenticator app such as Authy.
