...
2. Add the official Mender GPG key to your trusted `apt` keychain:
    ...
    ```
    ```
    pub   rsa3072 2020-11-13 [SC] [expires: 2028-09-14]
          E6C8 5734 5575 F921 8396  5662 2407 2B80 A1B2 9B00
    uid                      Mender Team <mender@northern.tech>
    sub   rsa3072 2020-11-13 [E] [expires: 2028-09-14]
    ```
...
matching your device.
    ...
    <!--AUTOMATION: ignore -->
    ```bash
    echo "deb [arch=$(dpkg --print-architecture)] https://downloads.mender.io/repos/device-components ubuntu/resolute/stable main" \
     | sudo tee /etc/apt/sources.list.d/mender.list
    ```
    [/ui-tab]
...
!! This is a preview of Mender's support for Orchestrated updates. It is not yet recommended for production use.

Mender offers [Mender Orchestrator](../../07.Orchestrate-updates/01.Overview/docs.md) which enables
coordinating OTA updates across a System of multiple Components. It applies updates in a
defined order and rolls back all Components if any part of the deployment fails, leaving the System as a whole in a well defined state.

To install `mender-orchestrator` using the Mender Orchestrator Debian packages, first
...
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Btrixie_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Btrixie_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Btrixie_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-support_0.7.0-1%2Bdebian%2Btrixie_all.deb
```
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Bbookworm_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Bbookworm_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Bbookworm_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-orchestrator-support_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-support_0.7.0-1%2Bdebian%2Bbookworm_all.deb
```
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bresolute_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bresolute_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bresolute_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-orchestrator-support_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-support_0.7.0-1%2Bubuntu%2Bresolute_all.deb
```
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bnoble_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bnoble_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bnoble_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-orchestrator-support_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-orchestrator/debian/0.7.0/mender-orchestrator-support_0.7.0-1%2Bubuntu%2Bnoble_all.deb
```
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Btrixie_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Btrixie_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Btrixie_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-orchestrator-support_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-support_0.7.0-1%2Bdebian%2Btrixie_all.deb
```
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Bbookworm_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Bbookworm_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bdebian%2Bbookworm_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-orchestrator-support_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-support_0.7.0-1%2Bdebian%2Bbookworm_all.deb
```
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bresolute_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bresolute_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bresolute_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-orchestrator-support_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-support_0.7.0-1%2Bubuntu%2Bresolute_all.deb
```
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bnoble_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bnoble_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-orchestrator-core_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-core_0.7.0-1%2Bubuntu%2Bnoble_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-orchestrator-support_%-1"/mender-orchestrator "/mender-orchestrator/debian/%/"/mender-orchestrator -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-orchestrator/debian/0.7.0/mender-orchestrator-support_0.7.0-1%2Bubuntu%2Bnoble_all.deb
```
...
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Btrixie_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Btrixie_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Btrixie_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Bbookworm_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Bbookworm_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Bbookworm_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bresolute_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bresolute_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bresolute_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bnoble_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bnoble_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bnoble_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Btrixie_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Btrixie_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Btrixie_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Bbookworm_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Bbookworm_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bdebian%2Bbookworm_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bresolute_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bresolute_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bresolute_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bnoble_armhf.deb
```
[/ui-tab]
[ui-tab title="arm64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bnoble_arm64.deb
```
[/ui-tab]
[ui-tab title="amd64"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway_%-1"/mender-gateway "/mender-gateway/debian/%/"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/debian/2.1.0/mender-gateway_2.1.0-1%2Bubuntu%2Bnoble_amd64.deb
```
[/ui-tab]
[/ui-tabs]
...
https://downloads.customer.mender.io/content/hosted/mender-gateway/examples/2.1.0/mender-gateway-2.1.0.tar
...
```bash
wget --auth-no-challenge --user "$HOSTED_MENDER_EMAIL" --password "$HOSTED_MENDER_PASSWORD" https://downloads.customer.mender.io/content/hosted/mender-gateway/examples/2.1.0/mender-gateway-examples-2.1.0.tar
```
[/ui-tab]
[ui-tab title="enterprise"]
Set the following variables with your credentials:
...
<!--AUTOVERSION: "/mender-gateway/examples/%/"/mender-gateway "/mender-gateway-examples-%.tar"/mender-gateway -->
```bash
wget --auth-no-challenge --user "$MENDER_ENTERPRISE_USER" --password "$MENDER_ENTERPRISE_PASSWORD" https://downloads.customer.mender.io/content/on-prem/mender-gateway/examples/2.1.0/mender-gateway-examples-2.1.0.tar
```
[/ui-tab]
[/ui-tabs]
