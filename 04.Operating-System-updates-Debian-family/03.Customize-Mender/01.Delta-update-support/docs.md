...
Once your devices support installing delta updates, see [Create a Delta update Artifact](../../../08.Artifact-creation/06.Create-a-Delta-update-Artifact/docs.md) for a tutorial on creating a delta update from two Operating System updates.
...
For information on creating Delta update Artifacts, see [Create a Delta update Artifact](../../../08.Artifact-creation/06.Create-a-Delta-update-Artifact/docs.md).
