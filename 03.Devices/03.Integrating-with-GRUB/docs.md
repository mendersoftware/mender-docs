...
!!! Please consult [the bootloader support section](../system-requirements/bootloader-support) to find out if GRUB is supported on your platform and build configuration, and whether it is enabled by default.
