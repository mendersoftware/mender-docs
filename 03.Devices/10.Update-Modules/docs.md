...
The built-in update mechanism in Mender is [dual rootfs updates](../../02.Overview/01.Overview/docs.md#robust-updates). To do other types of updates, you will need an _Update module_ for your device.
...
You will need a Mender server if you are using [managed mode](../../02.Overview/01.Overview/docs.md#modes-of-operation).
