...
If you [run the Mender client in standalone mode](../../02.Overview/01.Overview/docs.md#modes-of-operation), you can avoid this dependency by [disabling Mender as a system service](../../04.Artifacts/10.Yocto-project/02.Image-configuration/docs.md#disabling-mender-as-a-system-service).
