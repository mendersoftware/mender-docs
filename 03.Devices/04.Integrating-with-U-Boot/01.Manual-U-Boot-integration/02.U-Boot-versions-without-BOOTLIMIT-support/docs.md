...
`MACHINE`
type](https://github.com/mendersoftware/meta-mender/blob/sumo/meta-mender-qemu/recipes-bsp/u-boot/patches/experimental/0002-Enable-custom-bootlimit-code-for-vexpress-qemu.patch).
