...
!!! Note: Starting with `mender-connect` 3.0 and later versions (part of Mender Client 6.0 or later) more proactive defaults have been adopted to improve out-of-the-box reliability:
