...
>    02cd118..75b7831  2.6.3      -> origin/2.6.3
>    06f3212..e9e5df4  2.6.3     -> origin/2.6.3
> ```
...
user@local$ git diff HEAD..2.6.3 -- template
```
...
> ...
> Pulling mender-device-auth (mendersoftware/deviceauth:mender-2.6.3)...
> mender-2.6.3: Pulling from mendersoftware/deviceauth
> Digest: sha256:07ed10f6fdee40df1de8e10efc3115cb64b0c190bcf5bcd194b9f34086396058
> Status: Image is up to date for mendersoftware/deviceauth:mender-2.6.3
> Pulling mender-gui (mendersoftware/gui:mender-2.6.3)...
> mender-2.6.3: Pulling from mendersoftware/gui
> Digest: sha256:af2d2349f27dd96ca21940672aa3a91335b17153f8c7ef2ca865a9a7fdf2fd22
> Status: Image is up to date for mendersoftware/gui:mender-2.6.3
> Pulling mender-api-gateway (mendersoftware/api-gateway:mender-2.6.3)...
> mender-2.6.3: Pulling from mendersoftware/api-gateway
> Digest: sha256:0a2033a57f88afc38253a45301c83484e532047d75858df95d46c12b48f1f2f8
> Status: Image is up to date for mendersoftware/api-gateway:mender-2.6.3````
> ```
