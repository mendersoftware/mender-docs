...
```bash
git clone -b 3.6.3 https://github.com/mendersoftware/integration.git integration-3.6.3
```
...
run the following commands in the `integration-3.6.3` directory:
