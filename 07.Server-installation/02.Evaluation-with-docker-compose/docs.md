...
```bash
git clone -b 3.7.5 https://github.com/mendersoftware/integration.git integration-3.7.5
```
...
run the following commands in the `integration-3.7.5` directory:
