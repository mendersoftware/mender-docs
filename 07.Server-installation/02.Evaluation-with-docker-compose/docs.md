...
```bash
git clone -b 3.6.0-build3 https://github.com/mendersoftware/integration.git integration-3.6.0-build3
```
...
run the following commands in the `integration-3.6.0-build3` directory:
