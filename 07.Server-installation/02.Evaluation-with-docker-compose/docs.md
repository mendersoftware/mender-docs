...
```bash
git clone -b 3.7.4 https://github.com/mendersoftware/integration.git integration-3.7.4
```
...
run the following commands in the `integration-3.7.4` directory:
