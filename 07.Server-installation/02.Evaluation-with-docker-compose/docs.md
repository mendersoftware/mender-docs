...
```bash
git clone -b 3.6.5 https://github.com/mendersoftware/integration.git integration-3.6.5
```
...
run the following commands in the `integration-3.6.5` directory:
