...
```bash
git clone -b 3.2.0-build4 https://github.com/mendersoftware/integration.git integration-3.2.0-build4
```
...
run the following commands in the `integration-3.2.0-build4` directory:
