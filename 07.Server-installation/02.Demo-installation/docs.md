...
```bash
git clone -b 2.6.0-build2 https://github.com/mendersoftware/integration.git integration-2.6.0-build2
```

Change directory to the cloned repository:
<!--AUTOVERSION: "integration-%"/integration -->
```bash
 cd integration-2.6.0-build2
```
...
run the following commands in the `integration-2.6.0-build2` directory:
