...
```bash
git clone -b 2.7.2 https://github.com/mendersoftware/integration.git integration-2.7.2
```

Change directory to the cloned repository:
<!--AUTOVERSION: "integration-%"/integration -->
```bash
 cd integration-2.7.2
```
...
run the following commands in the `integration-2.7.2` directory:
