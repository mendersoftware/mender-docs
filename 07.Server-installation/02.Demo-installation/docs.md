...
```bash
git clone -b 3.2.1 https://github.com/mendersoftware/integration.git integration-3.2.1
```
...
run the following commands in the `integration-3.2.1` directory:
