...
```bash
git clone -b 3.3.2 https://github.com/mendersoftware/integration.git integration-3.3.2
```
...
run the following commands in the `integration-3.3.2` directory:
