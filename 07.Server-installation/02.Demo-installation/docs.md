...
```bash
git clone -b 3.2.0-build5 https://github.com/mendersoftware/integration.git integration-3.2.0-build5
```
...
run the following commands in the `integration-3.2.0-build5` directory:
