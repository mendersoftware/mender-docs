...
```bash
git clone -b 3.0.1 https://github.com/mendersoftware/integration.git integration-3.0.1
```

Change directory to the cloned repository:
<!--AUTOVERSION: "integration-%"/integration -->
```bash
 cd integration-3.0.1
```
...
run the following commands in the `integration-3.0.1` directory:
