...
```bash
git clone -b 3.5.0 https://github.com/mendersoftware/integration.git integration-3.5.0
```
...
run the following commands in the `integration-3.5.0` directory:
