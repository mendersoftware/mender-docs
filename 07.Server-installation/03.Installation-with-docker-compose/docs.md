...
taxonomy:
    ...
    label: tutorial
routes:
    canonical: /3.4/server-installation/installation-with-docker-compose
---
...
```bash
git clone -b 3.3.1 https://github.com/mendersoftware/integration mender-server
```
