...
>    02cd118..75b7831  3.4.0-build2      -> origin/3.4.0-build2
>    06f3212..e9e5df4  3.4.0-build2     -> origin/3.4.0-build2
> ```
...
user@local$ git diff HEAD..3.4.0-build2 -- template
```
