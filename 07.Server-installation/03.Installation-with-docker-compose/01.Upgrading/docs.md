...
>    02cd118..75b7831  3.5.0-build4      -> origin/3.5.0-build4
>    06f3212..e9e5df4  3.5.0-build4     -> origin/3.5.0-build4
> ```
...
user@local$ git diff HEAD..3.5.0-build4 -- template
```
