...
>    02cd118..75b7831  3.1.0-build5      -> origin/3.1.0-build5
>    06f3212..e9e5df4  3.1.0-build5     -> origin/3.1.0-build5
> ```
...
user@local$ git diff HEAD..3.1.0-build5 -- template
```
