...
taxonomy:
    ...
    label: tutorial
routes:
    canonical: /3.4/server-installation/installation-with-docker-compose/upgrading-from-os-to-enterprise
---
...
<!-- AUTOMATION: execute=git clone -b 3.3.1 https://github.com/mendersoftware/integration mender-server -->
