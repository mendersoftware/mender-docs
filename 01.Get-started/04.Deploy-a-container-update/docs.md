...
```bash
wget https://downloads.mender.io/mender-artifact/3.5.3/linux/mender-artifact -O ${HOME}/bin/mender-artifact
```
...
```bash
wget https://raw.githubusercontent.com/mendersoftware/mender/2.5.4/support/modules-artifact-gen/docker-artifact-gen
```
