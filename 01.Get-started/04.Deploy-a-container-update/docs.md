...
```bash
wget https://downloads.mender.io/mender-artifact/3.7.0-build2/linux/mender-artifact -O ${HOME}/bin/mender-artifact
```
...
<!--AUTOVERSION: "mender-artifact/%/"/mender-artifact -->
```bash
wget https://downloads.mender.io/mender-artifact/3.7.0-build2/darwin/mender-artifact -O ${HOME}/bin/mender-artifact
```
...
```bash
wget https://raw.githubusercontent.com/mendersoftware/mender/3.2.0-build2/support/modules-artifact-gen/docker-artifact-gen
```
