...
```bash
wget https://downloads.mender.io/mender-artifact/3.5.2/linux/mender-artifact -O ${HOME}/bin/mender-artifact
```
...
<!--AUTOVERSION: "mender-artifact/%/"/mender-artifact -->
```bash
wget https://downloads.mender.io/mender-artifact/3.5.2/darwin/mender-artifact -O ${HOME}/bin/mender-artifact
```
...
```bash
wget https://raw.githubusercontent.com/mendersoftware/mender/2.6.1/support/modules-artifact-gen/docker-artifact-gen
```
