...
You can find download and installation instructions for on-premise environments on [downloads](../../11.Downloads/02.Device-components/docs.md#mender-gateway) page.
