...
Mender. We will be using the [Monitor Add-on](../../11.Add-ons/20.Monitor/docs.md), allowing you to monitor various system parts.
...
!!! Note: This Alert will remain unless a manual [alert cleaning](../../11.Add-ons/20.Monitor/50.Advanced-use-cases/docs.md#alert-cleaning ) is performed:
!!! ```bash
!!! sudo su
...
!!! If you want to examine the low-level architecture of mender-monitor using this example [follow this link](../../11.Add-ons/20.Monitor/50.Advanced-use-cases/docs.md#example).
