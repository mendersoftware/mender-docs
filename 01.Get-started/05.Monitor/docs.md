...
To follow this tutorial and perform the examples, you will need to install the [Monitor Add-on package](../../10.Add-ons/20.Monitor/10.Installation/docs.md) and the [Demo monitors package](../../11.Downloads/02.Device-components/docs.md#demo-monitors) on your device. 
...
Demo Checks for the Mender Monitor Add-on, found in the [Demo monitors package](../../11.Downloads/02.Device-components/docs.md#demo-monitors) (Debian package) or in the `examples` directory for [Yocto](../../05.Operating-System-updates-Yocto-Project/05.Customize-Mender/docs.md#monitor) serve as a starting point for quick evaluation.
