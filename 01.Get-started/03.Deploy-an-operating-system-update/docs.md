...
For the repo setup and package installation please follow instructions at [Downloads page](../../11.Downloads/01.Workstation-tools/docs.md#set-up-the-apt-repository)
